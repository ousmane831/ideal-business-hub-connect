  ...
  return (
    <section className="bg-gradient-to-br from-red-50 to-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            <span className="text-red-600">IDEAL</span> Platform
          </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-red-600">1200+</div>
      ...
      <div className="flex justify-center mt-12">
        <ArrowDown className="h-6 w-6 text-red-600 animate-bounce" />
      </div>
    </section>
  );
};
